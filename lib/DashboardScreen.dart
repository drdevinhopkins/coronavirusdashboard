...
Widget _buildLargeDataBreakdown(BuildContext context, allScreenings) {
  return Padding(
    padding: const EdgeInsets.all(20.0),
    child: FutureBuilder(
      future: allScreenings,
      builder:
...
Widget _buildSmallDataBreakdown(BuildContext context, allScreenings) {
  return Padding(
